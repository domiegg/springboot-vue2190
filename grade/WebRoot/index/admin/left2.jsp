...
<dl class="leftmenu">
	...
	<dd>
		<div class="title">
			<span><img src="<%=basePath %>resource/admin/images/leftico01.png" /></span>教师管理
		</div>
		<ul class="menuson">
			<li><cite></cite><a href="user/selHc">教师管理</a><i></i></li>
		</ul>   
	</dd>
	<dd>
		<div class="title">
			<span><img src="<%=basePath %>resource/admin/images/leftico01.png" /></span>学生管理
		</div>
		<ul class="menuson">
			<li><cite></cite><a href="user/selHz">学生管理</a><i></i></li>
		</ul>   
	</dd>
	<dd>
		<div class="title">

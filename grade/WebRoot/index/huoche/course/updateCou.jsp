...
<form action = "course/updateCou" method = "post"  class="validate" onsubmit="return add();" >
	...
	<div class="formbody">
		...
		<ul class="forminfo">
			<li>
				<label>课程名称</label>
				<input name="kname" id="account" value="${c.kname}" type="text" class="dfinput  " placeholder="请输入课程名称" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			 <li>
				<label>课时</label>
				<input name="keshi" id="keshi" value="${c.keshi}" type="text" class="dfinput  " placeholder="请输入课时" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>课程介绍</label>

...
<form action = "user/saveUpdateHz" method = "post"  class="validate" onsubmit="return add();" >
	<div class="formbody">
	<input type="hidden" name="id" value="${user.id}"/>
		...
		<ul class="forminfo">
			<li>
			 ...
			 <li>
				<label>密码</label>
				<input name="password" id="password" type="password" value="${user.password}" class="dfinput  " placeholder="请输入密码" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			 <li>
				<label>年龄</label>
			...
			<li>
			 ...
			 <li>
				<label>班级</label>
				<input name="jsnumber" id="jsnumber" value="${user.jsnumber}" type="text" class="dfinput  " placeholder="班级" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>&nbsp;</label>

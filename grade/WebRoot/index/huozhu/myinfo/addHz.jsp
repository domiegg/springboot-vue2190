...
<form action = "user/saveHz" method = "post" enctype="multipart/form-data" class="validate" onsubmit="return add();" >
	<div class="formbody">
	<input type="hidden" name="role" value="${role}"/>
		...
		<ul class="forminfo">
			...
			<li>
			 ...
			 <li>
				<label>班级</label>
				<input name="jsnumber" id="jsnumber" type="text" class="dfinput  " placeholder="班级" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>照片</label>
